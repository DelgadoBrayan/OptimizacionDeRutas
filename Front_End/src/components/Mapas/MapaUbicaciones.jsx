...
import { useRutaContext } from '../Context/ContexRuta'
import {MapaRutaOptima} from '../Mapas/MapaRutaOptima'
...
export const MapaUbicaciones = () => {
  ...
  useEffect(() => {
    ...
    // const eliminarUbicacion = (indice) => {
    //   locations.filter((item, index)=> index !== indice)
